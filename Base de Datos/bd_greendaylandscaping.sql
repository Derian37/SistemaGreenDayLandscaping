...
-- Volcando estructura de base de datos para bd_greendaylandscaping
CREATE DATABASE IF NOT EXISTS `bd_greendaylandscaping` /*!40100 DEFAULT CHARACTER SET utf32 COLLATE utf32_bin */;
USE `bd_greendaylandscaping`;

-- Volcando estructura para procedimiento bd_greendaylandscaping.confirm_password
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.Costum_Customers
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.get_bill
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.get_billbydate
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.get_lastbill
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.get_lastcustomer
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.Insert_bills
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.Insert_Customers
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.Insert_newBills
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.Insert_saveBills
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.list_Bills
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.list_customerbyid
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.list_customers
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.list_savebillsbyid
DELIMITER //
...
BEGIN
	...
	WHERE tbl_customers.code= id_customer
	AND id_customer = tbl_bill.id_customer
	AND tbl_bill.id_bill = tbl_savebills.id_bill
   ORDER BY tbl_savebills.id_saveBills DESC;
END//
DELIMITER ;

-- Volcando estructura para procedimiento bd_greendaylandscaping.list_users
DELIMITER //
...
-- Volcando estructura para procedimiento bd_greendaylandscaping.modify_bill
DELIMITER //
...
-- Volcando estructura para tabla bd_greendaylandscaping.tbl_bill
...
REPLACE INTO `tbl_bill` (`id_bill`, `id_customer`, `id_user`, `fecha`, `details`) VALUES
	...
	(8, 1, 1, '0000-00-00', 'Prueba'),
	(9, 2, 1, '0000-00-00', 'prueba'),
	(10, 1, 1, '0000-00-00', 'qwe'),
	(11, 1, 1, '0000-00-00', 'ww'),
	(12, 1, 1, '0000-00-00', 'TT'),
	(13, 2, 1, '0000-00-00', 'DETALLE'),
	(14, 2, 1, '0000-00-00', 'prueba'),
	(15, 2, 1, '0000-00-00', 'prueba 2'),
	(16, 2, 1, '0000-00-00', 'prueba 3'),
	(17, 1, 1, '0000-00-00', 'Prueba 4');
/*!40000 ALTER TABLE `tbl_bill` ENABLE KEYS */;

-- Volcando estructura para tabla bd_greendaylandscaping.tbl_customers
...
-- Volcando datos para la tabla bd_greendaylandscaping.tbl_customers: ~13 rows (aproximadamente)
/*!40000 ALTER TABLE `tbl_customers` DISABLE KEYS */;
REPLACE INTO `tbl_customers` (`code`, `name`, `lastName`, `telephone`, `address`, `postalCode`, `staticPrice`) VALUES
...
-- Volcando estructura para tabla bd_greendaylandscaping.tbl_elementbill
...
REPLACE INTO `tbl_elementbill` (`id_billFac`, `id_bill`, `fecha`, `details`, `servicePrice`, `amount`) VALUES
	...
	(7, 13, '', 'HOLA', 200, 200),
	(8, 14, '01/08/2019', 'detalle', 500, 600),
	(9, 15, '01-06-2019', 'Prueba 3', 1000, 1000),
	(10, 15, '01-06-2019', 'arroz', 2000, 3000),
	(11, 15, '01-06-2019', 'dkdk', 5000, 8000),
	(12, 16, '01-06-2019', 'srive', 1133, 1133),
	(13, 17, '01-06-2019', 'Prueba', 528, 528);
/*!40000 ALTER TABLE `tbl_elementbill` ENABLE KEYS */;

-- Volcando estructura para tabla bd_greendaylandscaping.tbl_savebills
...
-- Volcando estructura para tabla bd_greendaylandscaping.tbl_users
